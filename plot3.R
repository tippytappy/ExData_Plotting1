...
# make the pdf and put the histogram in it
  png(file = "~/Plot3.png")
  plot(data$Time,data$Sub_metering_1, type = "l", ylab = "")
  lines(data$Time,data$Sub_metering_2, type = "l", col = "red", ylab = "")
  lines(data$Time,data$Sub_metering_3, type = "l", col = "blue", ylab = "")
